...
namespace DAL
{
    public class NhanLucBMAccess : DatabaseAccess
    {
        public List<ThongTinNhanLuc> HienThiNhanLucBM(string nam, string mabm)
        {
            List<ThongTinNhanLuc> NhanLucBM = new List<ThongTinNhanLuc>();
            OpenConnection();
            ...
            while (reader.Read())
            {
                ...
                ThongTinNhanLuc NLBM = new ThongTinNhanLuc();
                NLBM.TenGV = tengv;
                NLBM.TenChucVu = tencv;
                NLBM.TenHocHam = tenhh;
                NLBM.TenHocVi = tenhv;
                NLBM.MaGV = magv;
